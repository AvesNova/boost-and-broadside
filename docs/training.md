...
Checkpoints use `frontline_shields_v13`; older weights require retraining.
...
- **Observation schema.** Typed ship/field/zone/boundary tokens, independent team
  ...
  `observation_schema=frontline_shields_v13`. Successful firing globally reveals the shooter
