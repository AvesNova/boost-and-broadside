...
| Final rating | On the calibrated scale with the scripted controller fixed at 1000, the final live policy reads 1812.9 (±18.4 conditional SE) and the last frozen checkpoint 1816.8 (±9.5): a lead over scripted of about 813 Elo. Random reads −240.0. | **Verified.** [calibration result](../../checkpoints/resilient-resonance-682/elo_calibrated.json). The scripted-anchor shift carries ±6.2 in common across all ratings and cancels in comparisons. Do not mix in the online training rating (1547.3, a different estimator). |
