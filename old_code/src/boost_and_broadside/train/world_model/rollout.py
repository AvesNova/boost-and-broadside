...
def perform_rollout(
    model, input_states, input_actions, input_pos, team_ids, rollout_len
):
    """
    ...
    with torch.no_grad():
        ...
        for i in range(rollout_len):
            ...
            next_state[..., StateFeature.HEALTH] = (
                curr_s[..., StateFeature.HEALTH]
                + delta_target[..., TargetFeature.DHEALTH]
            ).clamp(0, 100.0)
            next_state[..., StateFeature.POWER] = (
                curr_s[..., StateFeature.POWER]
                + delta_target[..., TargetFeature.DPOWER]
            ).clamp(0, 100.0)
            next_state[..., StateFeature.VX] = (
                curr_s[..., StateFeature.VX] + delta_target[..., TargetFeature.DVX]
            )
            next_state[..., StateFeature.VY] = (
                curr_s[..., StateFeature.VY] + delta_target[..., TargetFeature.DVY]
            )
            next_state[..., StateFeature.ANG_VEL] = (
                curr_s[..., StateFeature.ANG_VEL]
                + delta_target[..., TargetFeature.DANG_VEL]
            )
