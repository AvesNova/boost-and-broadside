...
class TestFeatureNormalizer(unittest.TestCase):
    ...
    def test_min_max(self):
        ...
        self.assertTrue(
            torch.allclose(normed, torch.tensor([0.0, 0.5, 1.0]), atol=1e-5)
        )
    ...
    def test_z_score(self):
        ...
        self.assertTrue(
            torch.allclose(normed, torch.tensor([-1.0, 0.0, 1.0]), atol=1e-5)
        )
    ...
    def test_rms_scale(self):
        ...
        self.assertTrue(
            torch.allclose(normed, torch.tensor([0.0, 1.0, 2.0]), atol=1e-2)
        )
    ...
    def test_log_transform(self):
        ...
        self.assertTrue(
            torch.allclose(transformed, torch.tensor([0.0, 1.0]), atol=1e-5)
        )
    ...
    def test_symlog_transform(self):
        ...
        self.assertTrue(
            torch.allclose(transformed, torch.tensor([-1.0, 0.0, 1.0]), atol=1e-5)
        )
