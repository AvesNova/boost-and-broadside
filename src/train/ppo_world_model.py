"""
Custom PPO implementation for World Model.

Inherits from Stable Baselines3 PPO to inject Auxiliary Loss (Dynamics Prediction)
...
class WorldModelPPO(PPO):
    """
    PPO with Auxiliary Dynamics Loss.
    """
