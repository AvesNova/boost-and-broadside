...
from src.agents.sb3_adapter import TeamTransformerSB3Policy
from src.env.sb3_wrapper import SB3Wrapper
...
def train_rl(cfg: DictConfig, pretrained_model_path: Path | None = None) -> None:
    ...
    # Create environment
    n_envs = rl_config.get("n_envs", 1) # This one can have a default as it's often optional/local
