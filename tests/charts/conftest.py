"""Fixture renderers and artifacts for the chart registry's own tests.

These deliberately do not use the real renderers: what is under test here is the
registry contract, and a fixture renderer can be made to misbehave in ways a
real one never should.
"""
...
from boost_and_broadside.charts import renderer_api
from boost_and_broadside.charts.renderer_api import Renderer, register
...
def isolated_registry():
    ...
    Not autouse: the figure-set tests read the shipped set and need the real
...
def renderers(isolated_registry):
    """One single-file renderer and one directory renderer."""
