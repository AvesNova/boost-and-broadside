...
CALIB_ROWS = [
    {"_step": 100, "ladder/elo/live": 950.0, "ladder/elo/live_stderr": 12.0},
    {"_step": 200, "ladder/elo/live": 1200.0, "ladder/elo/live_stderr": 8.0},
    {"_step": 300, "ladder/elo/live": float("inf")},  # clean sweep, no stderr
]
...
class TestSeries:
    ...
    def test_works_identically_on_calibrated_rows(self):
        x, y = series(CALIB_ROWS, "ladder/elo/live")
...
class TestSeriesBand:
    def test_band_aligns_and_needs_both_value_and_error(self):
        x, y, lo, hi = series_band(CALIB_ROWS, "ladder/elo/live", "ladder/elo/live_stderr")
    ...
    def test_n_sigma_scales_the_band(self):
        _, _, lo, hi = series_band(
            CALIB_ROWS, "ladder/elo/live", "ladder/elo/live_stderr", n_sigma=2.0
        )
...
class TestCheckpointPoints:
    def test_reads_ckpt_ratings_and_stderr(self):
        summary = {
            "ladder/elo/ckpt_200": 1050.0, "ladder/elo/ckpt_200_stderr": 7.0,
            "ladder/elo/ckpt_100": 900.0, "ladder/elo/ckpt_100_stderr": 5.0,
            "ladder/elo/live": 1200.0,  # not a checkpoint
            "elo/scripted": 800.0,
        }
    ...
    def test_missing_stderr_is_nan(self):
        steps, ratings, errs = checkpoint_points({"ladder/elo/ckpt_50": 500.0})
