...
def mock_pipeline_components():
    with patch("src.modes.train.collect") as mock_collect, \
         patch("src.modes.train.train_bc") as mock_train_bc, \
         patch("src.modes.train.train_rl") as mock_train_rl:
...
def test_full_pipeline_execution(mock_pipeline_components):
    ...
    assert cfg.train.bc_data_path == "mock\\data\\path.pkl" or cfg.train.bc_data_path == "mock/data/path.pkl"
